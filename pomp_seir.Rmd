...
So we expect $\mu_{EI}$ to fall into the range of $\frac{1}{2\text{ wk} = 1/26\text{ yr}} = 26\text{ yr}^{-1}$ to $\frac{1}{2\text{ day} = 1/183\text{ yr}} = 183\text{ yr}^{-1}$.
It can take at least two weeks for people to recover from COVID-19 infection. [[3]](https://www.reuters.com/article/us-health-coronavirus-recovery-idUSKCN24P2DC). So we can expect $\mu_{IR}$ to fall into the range of $13-26\text{ yr}^{-1}$.
