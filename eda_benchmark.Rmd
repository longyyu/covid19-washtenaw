...
[Do we want to pick a subperiod to analyze, or do we want to use the full sample (Mar 1, 2020 - Apr 7, 2021)?]{.comment}
...
idx_max = which.max(smoothed$spec) # 1
idx_max2 = which.max(smoothed$spec[41:length(smoothed$spec)]) + 40 # 58
...
# AR3, MA4: AIC=287.0520
# AR1, MA1: AIC=288.1600
```
